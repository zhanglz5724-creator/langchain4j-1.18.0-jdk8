...
extends DefaultChatRequestParameters {
    public static final OpenAiOfficialResponsesChatRequestParameters EMPTY = OpenAiOfficialResponsesChatRequestParameters.builder().build();
    ...
    public OpenAiOfficialResponsesChatRequestParameters overrideWith(ChatRequestParameters that) {
        return OpenAiOfficialResponsesChatRequestParameters.builder().overrideWith((ChatRequestParameters)this).overrideWith(that).build();
    }

    public OpenAiOfficialResponsesChatRequestParameters defaultedBy(ChatRequestParameters that) {
        return OpenAiOfficialResponsesChatRequestParameters.builder().overrideWith(that).overrideWith((ChatRequestParameters)this).build();
    }
    ...
    public boolean equals(Object o) {
        ...
        OpenAiOfficialResponsesChatRequestParameters that = (OpenAiOfficialResponsesChatRequestParameters)((Object)o);
    ...
    extends DefaultChatRequestParameters.Builder<Builder> {
        ...
        public Builder overrideWith(ChatRequestParameters parameters) {
            ...
            if (parameters instanceof OpenAiOfficialResponsesChatRequestParameters) {
                OpenAiOfficialResponsesChatRequestParameters p = (OpenAiOfficialResponsesChatRequestParameters)parameters;
                ...
                this.reasoningEffort((ReasoningEffort)Utils.getOrDefault((Object)p.reasoningEffort(), (Object)this.reasoningEffort));
                this.reasoningSummary((Reasoning.Summary)Utils.getOrDefault((Object)p.reasoningSummary(), (Object)this.reasoningSummary));
