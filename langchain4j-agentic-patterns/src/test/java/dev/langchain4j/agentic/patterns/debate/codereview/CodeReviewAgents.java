...
public class CodeReviewAgents {
    ...
    public interface BugHunter {
        ...
        @UserMessage("                You are a code reviewer focused on correctness and bug detection. \\\n"
...
+ "                ")
    ...
    public interface SecurityReviewer {
        ...
        @UserMessage("                You are a code reviewer focused on security vulnerabilities. \\\n"
...
+ "                ")
    ...
    public interface DesignCritic {
        ...
        @UserMessage("                You are a code reviewer focused on design quality and maintainability. \\\n"
...
+ "                ")
    ...
    public interface ReviewSummarizer {
        ...
        @UserMessage("                You are a senior engineer summarizing a code review. \\\n"
