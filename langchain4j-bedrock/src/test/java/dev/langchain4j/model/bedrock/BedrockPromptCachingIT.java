...
class BedrockPromptCachingIT {
    ...
    void should_chat_with_bedrock_system_message_granular_cache_points() {
        ...
        String largeStaticContent = repeat("You are an experienced coding assistant. ", 100);
    ...
    void should_benefit_from_cache_with_bedrock_system_message() {
        ...
        String largeStaticContent =
                repeat("You are an experienced coding assistant with expertise in Java, Python, JavaScript, and more. ",
                        100);
    ...
    void should_handle_mixed_system_message_types() {
        ...
        String largeContent = repeat("You have expertise in software development. ", 100);
    ...
    void should_combine_granular_cache_points_with_tools() {
        ...
        String largeToolInstructions = repeat("You have access to the following tools: ", 50);
    ...
    void should_handle_bedrock_system_message_without_chat_memory() {
        ...
        String largeSystemContent = repeat("You are an AI assistant with extensive knowledge. ", 100);
