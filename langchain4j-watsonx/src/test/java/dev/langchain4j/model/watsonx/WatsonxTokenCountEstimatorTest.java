...
public class WatsonxTokenCountEstimatorTest {
    ...
    void testWatsonxTokenCountEstimatorBuilder() throws Exception {
        ...
        when(mockHttpResponse.body())
                .thenReturn(Json.toJson(new TokenizationResponse("my-model", new Result(10, Arrays.asList()))));
    ...
    void testTokenize() {
        ...
        when(mockTokenizationService.tokenize("tokenize", null))
                .thenReturn(new TokenizationResponse("my-model", new Result(10, Arrays.asList())));
    ...
    void testTokenizeWithParameters() {
        ...
        when(mockTokenizationService.tokenize("tokenize", parameters))
                .thenReturn(new TokenizationResponse("model-id", new Result(10, Arrays.asList())));
        ...
        withTokenizationServiceMock(() -> {
            ...
            assertThrows(
                    ...
                    () -> tokenCountEstimator.estimateTokenCountInMessage(UserMessage.builder()
                            .contents(Arrays.asList(ImageContent.from("test", DetailLevel.HIGH)))
                            .build()));

            assertThrows(
                    UnsupportedOperationException.class,
                    () -> tokenCountEstimator.estimateTokenCountInMessage(CustomMessage.from(Collections.singletonMap("test", "test"))));
        });
    }
    ...
    void testEstimateTokenCountInMessages() {
        ...
        withTokenizationServiceMock(() -> {
            ...
            Iterable<ChatMessage> messages = Arrays.asList(
                    SystemMessage.from("test"),
                    UserMessage.builder()
                            .name("test")
                            .contents(Arrays.asList(TextContent.from("test")))
                            .build(),
                    AiMessage.builder()
                            .thinking("test")
                            .text("test")
