...
class WatsonxChatRequestParametersTest {
    ...
    private static WatsonxChatRequestParameters.Builder fullyPopulated() {
        return WatsonxChatRequestParameters.builder()
                ...
                .spaceId("space-id")
                .logitBias(Collections.singletonMap("token", 1))
                .logprobs(true)
                .topLogprobs(5)
                .seed(42)
                .toolChoiceName("tool")
                .timeout(Duration.ofSeconds(10))
                .guidedChoice(new HashSet<>(Arrays.asList("a", "b")))
                .guidedRegex("[0-9]+")
    ...
    void equals_should_distinguish_each_watsonx_field() {
        ...
        assertThat(base)
                .isNotEqualTo(fullyPopulated().logitBias(Collections.singletonMap("token", 2)).build());
        ...
        assertThat(base).isNotEqualTo(fullyPopulated().guidedChoice(new HashSet<>(Arrays.asList("c"))).build());
