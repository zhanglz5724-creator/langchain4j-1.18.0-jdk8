...
public class McpRuntimeArgument {
    ...
    public String toString() {
        ...
        return "McpRuntimeArgument{choices=" + this.choices + ", defaultValue='" + maskedDefaultValue + '\'' + ", description='" + this.description + '\'' + ", format='" + this.format + '\'' + ", isRepeated=" + this.isRepeated + ", isRequired=" + this.isRequired + ", isSecret=" + this.isSecret + ", name='" + this.name + '\'' + ", type='" + this.type + '\'' + ", value='" + maskedValue + '\'' + ", valueHint='" + this.valueHint + '\'' + ", variables=" + this.variables + '}';
    }
}
