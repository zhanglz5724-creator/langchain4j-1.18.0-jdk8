...
@Experimental
public class OpenAiResponsesChatModel
implements ChatModel {
    ...
    private OpenAiResponsesChatModel(Builder builder) {
        ...
        if (builder.defaultRequestParameters != null) {
            OpenAiResponsesChatModel.validate(builder.defaultRequestParameters);
